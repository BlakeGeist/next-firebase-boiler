...
const Index = ({
  ...
  return __jsx(_layouts_Layout__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
    pageMod: "index"
  }, "Home PAge");
};
...
Index.getInitialProps = async ({
  ...
  let card = await axios__WEBPACK_IMPORTED_MODULE_3___default.a.get('https://api.scryfall.com/cards/random');
  reduxStore.dispatch({
    type: 'SET_ITEM',
    name: 'card',
    payload: card.data
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_1__["connect"])(state => state)(Index));
