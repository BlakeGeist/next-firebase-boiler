...
module.exports = __webpack_require__("aqZc");
...
/* harmony import */ var firebase_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("EuFW");
...
/* harmony import */ var _credentials_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("hmoh");
...
/* harmony import */ var _layouts_Layout__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("JwBy");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__("4Q3z");
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var recompose__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("NnCY");
/* harmony import */ var recompose__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(recompose__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _components_AuthForm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__("Bqhj");
/* harmony import */ var _components_LoadingSpinner__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__("D9KS");
...
const LoginBase = ({
  ...
  if (!firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.apps.length) {
    firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.initializeApp(_credentials_client__WEBPACK_IMPORTED_MODULE_5___default.a);
  }
  ...
  const handleChange = event => {
    let tempObj = Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])({}, state);
  ...
  const handleEmailPassAuth = e => {
    ...
    firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.auth().signInWithEmailAndPassword(email, password).catch(function (error) {
  ...
  const onAuthStateChange = async user => {
    if (user && user.uid) {
      ...
      next_router__WEBPACK_IMPORTED_MODULE_7___default.a.push(`/${lang}/dashboard`);
    }
  };

  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(() => {
    const unsubscribe = firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.auth().onAuthStateChanged(onAuthStateChange);
    return () => unsubscribe();
  });
  return __jsx(_layouts_Layout__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
    pageMod: "about"
  }, __jsx("h1", {
  ...
  }, __jsx(_components_AuthForm__WEBPACK_IMPORTED_MODULE_9__[/* default */ "a"], {
    ...
    className: "jsx-2762284588"
  }, "Sign In with Google"))), __jsx(_components_LoadingSpinner__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"], {
    isLoading: isLoading
...
const Login = Object(recompose__WEBPACK_IMPORTED_MODULE_8__["compose"])(Object(recompose__WEBPACK_IMPORTED_MODULE_8__["withState"])('state', 'setState', {
  email: '',
  password: '',
  isLoading: false,
  errorMessage: ''
}))(LoginBase);
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_11__["connect"])(state => state)(Login));
