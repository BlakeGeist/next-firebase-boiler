...
module.exports = __webpack_require__("JaPf");
...
const SignUpBase = ({
  ...
  const handleEmailPassAuth = e => {
    ...
    firebase_app__WEBPACK_IMPORTED_MODULE_3___default.a.auth().createUserWithEmailAndPassword(email, password).catch(function (error) {
  ...
  return __jsx(_layouts_Layout__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
    ...
    className: "jsx-1950101003"
  }, "Sign Up with Google")), __jsx(_components_LoadingSpinner__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"], {
    isLoading: isLoading
...
const SignUp = Object(recompose__WEBPACK_IMPORTED_MODULE_8__["compose"])(Object(recompose__WEBPACK_IMPORTED_MODULE_8__["withState"])('state', 'setState', {
  email: '',
  password: '',
  isLoading: false,
  errorMessage: ''
